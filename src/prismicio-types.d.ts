...
export interface CaseStudiesSliceDefaultPrimaryCaseStudyItem {
	...
	case_study: ContentRelationshipFieldWithData<
		[
			{
				id: 'case_study';
				fields: ['company', 'description', 'meta_title', 'image', 'meta_description', 'meta_image'];
			}
		]
	>;
}
...
export interface IntegrationsSliceDefaultPrimaryIconItem {
	 ...
	 */
	icon: prismic.SelectField<'shield' | 'umbrella' | 'document' | 'heart'>;
}
...
export interface ShowcaseSliceDefaultPrimary {
	...
	/**
	 * Link field in *Showcase → Default → Primary*
	 *
	 * - **Field Type**: Link
	 * - **Placeholder**: *None*
	 * - **API ID Path**: showcase.default.primary.link
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	link: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;
...
export interface ShowcaseSliceReversePrimary {
	...
	/**
	 * Link field in *Showcase → Reverse → Primary*
	 *
	 * - **Field Type**: Link
	 * - **Placeholder**: *None*
	 * - **API ID Path**: showcase.reverse.primary.link
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	link: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;
