<script lang="ts">
	...
	import SpanHeading from '$lib/components/SpanHeading.svelte';
...
>
	<div
		class="absolute -z-10 aspect-video w-full max-w-2xl rounded-full bg-violet-500/40 mix-bled-screen blur-[120px] filter"
	/>
	...
	<div
		class="realative mt-16 grid items-center gap-8 rounded-xl border border-violet-50/20 bg-linear-to-b from-gray-50/15 to-gray-50/5 px-8 py-8 backdrop-blur-sm lg:grid-cols-3 lg:gap-0 lg:py-12"
	>
		...
		<div>
			...
			{#if slice.primary.link}
				<ButtonLink field={slice.primary.link} class="mt-6"
